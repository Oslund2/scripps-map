...
export const MARKETS = [
  ...
  { id: "fort-myers",      name: "Fort Myers",       dmaRank: 58,  lat: 26.6406, lon: -81.8723, category: "opportunity",
    stations: { scripps: [], inyo: [] }, voices: 9,
    fcc: { top4Pass: null, voices8Pass: true, compliant: null, notes: "WFTX sold to Sun Broadcasting Mar 2, 2026. No current Scripps station. Potential re-entry market." } },
  { id: "colorado-springs",name: "Colorado Springs", dmaRank: 89,  lat: 38.8339, lon: -104.8214, category: "new_duopoly",
    stations: { scripps: ["KOAA", "KKTV"], inyo: [] }, voices: 8,
    fcc: { top4Pass: true, voices8Pass: true, compliant: true, notes: "KKTV (CBS) acquiring from Gray swap — FCC approved Apr 28, 2026, close pending. CBS+NBC duopoly. Top-4 prohibition vacated Jul 2025 (Eighth Circuit)." } },
  { id: "lansing",         name: "Lansing",          dmaRank: 113, lat: 42.7325, lon: -84.5555, category: "opportunity",
    stations: { scripps: ["WSYM"], inyo: [] }, voices: 7,
    fcc: { top4Pass: null, voices8Pass: false, compliant: null, notes: "WSYM swapping to Gray — FCC approved Apr 28, 2026, close pending. Will have no Scripps station after close." } },
  ...
  { id: "lafayette",       name: "Lafayette",        dmaRank: 123, lat: 30.2241, lon: -92.0198, category: "opportunity",
    ...
    fcc: { top4Pass: null, voices8Pass: false, compliant: null, notes: "KATC swapping to Gray — FCC approved Apr 28, 2026, close pending. Will have no Scripps station after close." } },
  { id: "twin-falls",      name: "Twin Falls",       dmaRank: 189, lat: 42.5629, lon: -114.4609, category: "new_duopoly",
    stations: { scripps: ["KSAW", "KMVT"], inyo: [] }, voices: 5,
    fcc: { top4Pass: true, voices8Pass: false, compliant: null, notes: "KMVT (CBS) acquiring from Gray swap — FCC approved Apr 28, 2026, close pending. ABC+CBS duopoly. Small market — waiver likely needed for 8-voice (top-4 prohibition vacated Jul 2025)." } },
  { id: "grand-junction",  name: "Grand Junction",   dmaRank: 190, lat: 39.0639, lon: -108.5506, category: "opportunity",
    stations: { scripps: ["KKCO"], inyo: [] }, voices: 5,
    fcc: { top4Pass: null, voices8Pass: false, compliant: null, notes: "KKCO (NBC) acquiring from Gray swap — FCC approved Apr 28, 2026, close pending. Very small market; standalone NBC station." } },
...
const ENRICHMENT = {
  ...
  "twin-falls":       { tvHouseholds: 84520,   estRevenueM: 5,   politicalSwing: false },
  "grand-junction":   { tvHouseholds: 97780,   estRevenueM: 6,   politicalSwing: true },
  // New INYO markets
